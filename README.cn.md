...
![ktop](https://repo.x-cmd.io/ktop.svg?lang=zh)
...
合计: **19,738** 行代码（覆盖前 5 种语言、共 **97** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 18,054 | 2,655 | 3,343 | 74 |
| Yaml | 978 | 58 | 22 | 14 |
| Sh | 540 | 87 | 76 | 7 |
| Html | 110 | 0 | 13 | 1 |
| Css | 55 | 11 | 13 | 1 |
...
- **最新版本**: `v0.5.3` (2026-01-12)
- **最近提交**: 2026-05-15
- **Release 含资产**: 13 个

## 流行度

- **Star**: 1,107 · **Fork**: 25 · **开放 issue**: 77 · **贡献者**: 6

## 累计统计

- **发布数**: 12 · **已合并 PR**: 70 · **开放 PR**: 2 · **已关闭 issue**: 68 · **开放 issue**: 9 · **提交数**: 129
...
| last180d | 2026-03-16 | 0 | 2 | 2 | 1 | 5 | 2 |
| 360d | 2025-09-17 | 4 | 45 | 2 | 41 | 5 | 44 |
| last720d | 2024-09-22 | 6 | 52 | 2 | 45 | 5 | 54 |
...
在 [repology.org](https://repology.org/project/ktop) 上共有 **11** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Homebrew | `0.5.3` | ✅ latest |
| Void | `0.5.3` | ✅ latest |
| openSUSE Tumbleweed | `0.5.3` | ✅ latest |

## 改进这些数据

ktop 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ktop` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ktop.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:49:54Z._
