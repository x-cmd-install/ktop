...
Total: **19,738** lines of code across **97** files in the top 5 languages.
...
- **Upstream**: <https://github.com/vladimirvivien/ktop>
...
- **Stars**: 1,107 · **Forks**: 25 · **Open issues**: 77 · **Contributors**: 6

## Totals (cumulative)

- **Releases**: 12 · **Merged PRs**: 70 · **Open PRs**: 2 · **Closed issues**: 68 · **Open issues**: 9 · **Commits**: 129
...
Reported by **11** distros on [repology.org](https://repology.org/project/ktop). **4** are ✅ on the latest upstream release, **5** are ⚠️ on an older version.
...
_Snapshot: `data/card/260912.yml` · 2026-09-12T04:49:54Z._
